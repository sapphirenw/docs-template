						...
						>
							<div className="overflow-hidden rounded-xl border border-border bg-background shadow-2xl shadow-black/20">
								...
								<div className="flex items-center gap-3 border-b border-border px-4">
									<Search className="h-4 w-4 shrink-0 text-foreground-soft" />
									<input
										ref={inputRef}
										type="text"
										value={query}
										...
										className="flex-1 bg-transparent py-3 text-[15px] text-foreground outline-hidden placeholder:text-foreground-soft"
									/>
									<kbd className="hidden items-center gap-0.5 rounded-sm bg-background-muted px-1.5 py-1 text-[11px] font-medium text-foreground-soft sm:flex">
								...
								<div className="flex items-center justify-between border-t border-border bg-background-soft/50 px-4 py-2.5 text-xs text-foreground-soft">
									<div className="flex items-center gap-3">
										<span className="flex items-center gap-1">
											<kbd className="rounded-sm bg-background-muted px-1.5 py-0.5 font-medium">
												↑
											</kbd>
											<kbd className="rounded-sm bg-background-muted px-1.5 py-0.5 font-medium">
												↓
