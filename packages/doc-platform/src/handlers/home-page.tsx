...
interface CreateHomePageOptions {
  customComponents?: Record<string, any>;
}

export function createHomePage(options?: CreateHomePageOptions) {
  async function generateMetadata(): Promise<Metadata> {
    const rootSlug = getRootPageSlug();
    const doc = await getDocBySlug(rootSlug, options?.customComponents);
  ...
  return { HomePage, generateMetadata };
}
