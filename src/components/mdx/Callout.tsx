	...
	return (
		...
		>
			<div className="mb-4 mt-2 flex items-center gap-3">
				<Icon
					className={clsx('h-5 w-5 flex-shrink-0', config.iconClass)}
				/>
				<span
					className={clsx('text-sm font-semibold', config.titleClass)}
				>
					{displayTitle}
				</span>
			</div>
			<div className="my-2 ml-8 text-sm text-foreground-muted [&>p]:m-0">
				{children}
			</div>
		</div>
	);
