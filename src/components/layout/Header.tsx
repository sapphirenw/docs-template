		...
		<header className="glass sticky top-0 z-50 h-16 border-b border-border">
			<div className="mx-auto flex h-full max-w-screen-2xl items-center justify-between px-4">
				...
				>
					...
					<kbd className="hidden items-center gap-0.5 rounded border border-border/50 bg-background px-1.5 py-0.5 text-[11px] font-medium text-foreground-soft sm:inline-flex">
						<span>⌘</span>K
					</kbd>
				</button>
